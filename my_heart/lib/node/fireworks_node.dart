...
class FireworksNode extends NodeWithSize {
  //src. https://github.com/vlidholt/flutter_clock/tree/master/fireworks_clock
  final ui.Image image;

  FireworksNode({required this.image, required Size resolution})
      : super(resolution);
  ...
  void _addExplosion() {
    ...
    ParticleSystem system = ParticleSystem(
      ...
      colorSequence:
          ColorSequence.fromStartAndEndColor(start: startColor, end: endColor),
    );
